 ...
 * @author root
 */
public class PortFolioOibaPojo {
    Integer sNo;
    ...
    String fSssGNo;
    String fSsssGNo;
    public BigDecimal commAmt, noteAmt, interAmt, leaseAmt, slrAmt;
    ...
    public BigDecimal getSlrAmt() {
        return slrAmt;
    }

    public void setSlrAmt(BigDecimal slrAmt) {
        this.slrAmt = slrAmt;
    }
