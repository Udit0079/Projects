<%-- 
    Document   : salaryProjection
    Created on : Feb 15, 2017, 12:34:58 PM
    Author     : Admin
--%>
...
<f:view>
    <html>
        ...
        <body>
            <a4j:form id="salaryProjectionForm">
                <h:panelGrid id="mainPanel" bgcolor="#fff" columns="1" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid columns="3" id="gridPanel1" style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup id="groupPanel2" layout="block">
                            ...
                            <h:outputText id="stDate" styleClass="output" value="#{SalaryProjection.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="OL30" styleClass="headerLabel" value="Salary Projection"/>
                        <h:panelGroup id="groupPanel3" layout="block">
                            <h:outputLabel id="label3" styleClass="headerLabel" value="User:"/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{SalaryProjection.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="gridPanel2" width="100%" style="height:1px;text-align:center" styleClass="error">
                        <h:outputText id="errMsg" value="#{SalaryProjection.message}"/>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col2,col7,col2,col7" columns="4" id="gridPanel5" style="text-align:left;" width="100%" styleClass="row1">
                        ...
                        <h:selectOneListbox id="ddReportType" value="#{SalaryProjection.reportType}" styleClass="ddlist" size="1" style="width:70px">
                            <f:selectItems value="#{SalaryProjection.reportTypeList}"/>
                            <a4j:support event="onblur" action="#{SalaryProjection.onRportType}" reRender="monthCategoryList"/>
                        </h:selectOneListbox> 
                        <h:outputLabel/>
                        <h:outputLabel/>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col2,col7,col2,col7" columns="4" id="gridPanel6" style="text-align:left;" width="100%" styleClass="row1">
                        <h:outputLabel id="SalaryProjectionCategory" styleClass="output" value="Salary Projection Category"><font class="required" style="color:red;">*</font></h:outputLabel>
                            <h:selectOneListbox id="SalaryProjectionCategoryList" styleClass="ddlist" size="1" style="width:150px" value="#{SalaryProjection.projectionCateory}">
                                <f:selectItems value="#{SalaryProjection.projectionCateoryList}"/>
                                <a4j:support event="onblur" action="#{SalaryProjection.onChangeCategory}" oncomplete="if(#{SalaryProjection.employeeWise=='true'})
                            ...
                            <h:selectOneListbox disabled="#{SalaryProjection.disableCategorizeDetails}" id="categorizationList" styleClass="ddlist" size="1" style="width:120px" value="#{SalaryProjection.categorizationDetails}">
                                <f:selectItems value="#{SalaryProjection.categorizationDetailsList}"/>
                            </h:selectOneListbox>
                        </h:panelGrid>
                        <h:panelGrid columnClasses="col2,col7,col2,col7" columns="4" id="gridPanel12" style="text-align:left;" width="100%" styleClass="row2">
                            ...
                            <h:selectOneListbox id="ddYear" styleClass="ddlist" size="1" style="width:150px" value="#{SalaryProjection.year}">
                                <f:selectItems value="#{SalaryProjection.yearList}"/>
                            </h:selectOneListbox>
                            ...
                            <h:selectOneListbox id="monthCategoryList" styleClass="ddlist" size="1" style="width:100px" value="#{SalaryProjection.monthCategory}" disabled="#{SalaryProjection.disableMonth}">
                                <f:selectItems value="#{SalaryProjection.monthCategoryList}"/>
                            </h:selectOneListbox>
                        </h:panelGrid>
                        <h:panelGrid id="salryFooter" style="width:100%;text-align:center;" styleClass="footer">
                            <h:panelGroup id="footerPanel">
                                <h:commandButton id="save" value="PDF Download" action="#{SalaryProjection.salaryProjectionRep}" />
                                <a4j:commandButton id="cancel" value="Refresh" action="#{SalaryProjection.refresh}" reRender="monthCategoryList,save,postSalaryButton,monthCategoryList,categorizationList,salaryTable,salaryGrid,categorizationList,salaryProcessingCategoryList,errMsg,PanelGridEmptable"/>
                                <a4j:commandButton id="exit" value="Exit" action="#{SalaryProjection.btnExitAction}" reRender="monthCategoryList,save,postSalaryButton,monthCategoryList,categorizationList,salaryTable,salaryGrid,categorizationList,salaryProcessingCategoryList,errMsg,PanelGridEmptable"/>
                            </h:panelGroup>
                        </h:panelGrid>
                    </h:panelGrid>
                </a4j:form>
                    ...
                    <h:form>
                        <h:panelGrid id="PanelGridEmptable" bgcolor="#fff" styleClass="row2" columns="1" width="100%">
                            <h:panelGrid  id="gridPanel77" columns="6" columnClasses="col3,col3,col3,col3,col3,col3" style="text-align:center;" width="100%">
                                ...
                                <h:selectOneListbox id="ddSearchCriteria" value="#{SalaryProjection.empSearchCriteria}" size="1">
                                    <f:selectItem itemValue="ID"/>
                                    <f:selectItem itemValue="Name"/>
                                </h:selectOneListbox>
                                <h:inputText maxlength="20" id="txtSearchValue" value="#{SalaryProjection.empSearchValue}" onkeyup="this.value = this.value.toUpperCase();" styleClass="input">
                                    <a4j:support event="onblur" action="#{SalaryProjection.getEmployeeDetails}" reRender="emptablepanel,EmpDetail,noOfRows,table1,taskList1"/>
                                </h:inputText>
                                <h:outputText/>
                            </h:panelGrid>
                            <h:panelGrid columnClasses="vtop" columns="1" id="table1" styleClass="row2" width="100%">
                                <rich:dataTable value="#{SalaryProjection.empSearchTable}"  var="dataItem" rowKeyVar="row" width="100%"
                                ...
                                <rich:column style="text-align:center;width:40px">
                                    <a4j:commandLink id="selectlink" action="#{SalaryProjection.setEmpRowValues}"  oncomplete="#{rich:component('empSearchModelPanel')}.hide();"  
                                        ...
                                        <f:setPropertyActionListener value="#{dataItem}" target="#{SalaryProjection.currentItem}"/>
                                    </a4j:commandLink>
                                </rich:column>
                                <f:facet name="footer">
                                    <h:outputText value="#{SalaryProjection.totalEmpRecords} active employees found" style="text-align:center" />
                                </f:facet>
                            </rich:dataTable>
