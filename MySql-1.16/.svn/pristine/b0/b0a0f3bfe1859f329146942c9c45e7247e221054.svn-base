...
<%
    ...
    if (brCode == null) {
        ...
        if (null == request.getHeader("referer") || request.getHeader("referer").contains("Welcome.jsp")|| request.getHeader("referer").contains("invalidOpError.jsp")) {
            response.sendRedirect("/cbs-jsp/login.jsp");
        }
    }
%>
<html>
    <head>
        <title>e-Core::Session Timeout</title>
    ...
    <body class="body">
        <table cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="alert_table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="alert_text">e-Core Alert</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <ul>
                                                                <br/>
                                                                <li>
                                                                    <p>Your Banking session is closed because you did not perform any activity in the application.<br/></p>
                                                                </li>
                                                                <li>Please <a href="/cbs-jsp/login.jsp">Click Here</a> for login again.</li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                </tbody>
                ...
                <tr>
                    <td ><div class="footer"> &copy;&nbsp;Copyright Citizen Co-operative Bank Ltd.</div></td>
                </tr>
            </tbody>
        </table>
    </body>
