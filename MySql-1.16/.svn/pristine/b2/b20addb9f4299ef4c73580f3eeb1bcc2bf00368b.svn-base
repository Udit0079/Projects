 ...
 */
@Embeddable
public class HrInterviewDtSalPK extends BaseEntity implements Serializable {
    ...
    public HrInterviewDtSalPK() {
    }

    public HrInterviewDtSalPK(int compCode, String intCode, String advtCode, String jobCode, String candSrno) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HrInterviewDtSalPK)) {
            return false;
        }
        HrInterviewDtSalPK other = (HrInterviewDtSalPK) object;
    ...
    public String toString() {
        return "entity.hr.HrInterviewDtSalPK[compCode=" + compCode + ", intCode=" + intCode + ", advtCode=" + advtCode + ", jobCode=" + jobCode + ", candSrno=" + candSrno + "]";
    }
