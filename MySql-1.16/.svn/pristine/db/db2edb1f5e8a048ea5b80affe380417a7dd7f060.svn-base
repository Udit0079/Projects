...
public class LoanInterestCalculation extends BaseBean {
    ...
    public LoanInterestCalculation() {
        try {
    ...
    public void getValues() {
        try {
            ...
            resultList = beanRemote.getAcctType();
...
//                    }
            ...
            List<LoanIntCalcList> resultList = beanRemote.cbsLoanIntCalc(option, accType, acno, sdf.format(fromDate), sdf.format(toDate), creditAmt, getUserName(), getOrgnBrCode());
    ...
    public void Post() {        
        ...
        try {
            ...
            setDisablePost(true);
            String result = beanRemote.loanInterestPosting(intCalc, option, accType, acno, sdf.format(fromDate), sdf.format(toDate), creditAmt, getUserName(), getOrgnBrCode());
            intCalc = new ArrayList<IntCalTable>();
            setMessage(result);
            setAllAccount("");
            setAccountWise("");
