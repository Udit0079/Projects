 ...
 */
@Embeddable
public class ShareReconPK implements Serializable {
    ...
    public ShareReconPK(String acno, Date dt, double recno) {
        this.acno = acno;
        this.dt = dt;
        this.recno = recno;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ShareReconPK)) {
            return false;
        }
        ShareReconPK other = (ShareReconPK) object;
    ...
    public String toString() {
        return "com.cbs.entity.ho.investment.ShareReconPK[ acno=" + acno + ", dt=" + dt + ", recno=" + recno + " ]";
    }
