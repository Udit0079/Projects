 ...
 * @author root
 */
public class InterestCodeMasterTable {
   private Integer sno;
    private String intTableCode;
//    private Float loanPeriodMonths;
//    private Float loanPeriodDays;
    ...
    private Float normalIntPer;
    private String normalIntInd;
    private Float peenalIntPer;
    private String peenalIntInd;
    private Float cleanIntPer;
    private String cleanPortionInd;
    private Float qisIntPer;
    private String qisPortionInd;
    private Float additionalInt;
    ...
    private Integer intSlabVerNo;
    private Integer intVerNo;
    ...
    public Float getAdditionalInt() {
        return additionalInt;
    }

    public void setAdditionalInt(Float additionalInt) {
    ...
    public Float getCleanIntPer() {
        return cleanIntPer;
    }

    public void setCleanIntPer(Float cleanIntPer) {
    ...
    public Integer getIntSlabVerNo() {
        return intSlabVerNo;
    }

    public void setIntSlabVerNo(Integer intSlabVerNo) {
        this.intSlabVerNo = intSlabVerNo;
    }
...
//   public Float getLoanPeriodDays() {
//        return loanPeriodDays;
//    }
//
//    public void setLoanPeriodDays(Float loanPeriodDays) {
//        this.loanPeriodDays = loanPeriodDays;
//    }
//
//    public Float getLoanPeriodMonths() {
//        return loanPeriodMonths;
//    }
//
//    public void setLoanPeriodMonths(Float loanPeriodMonths) {
...
//    }
    ...
    public Float getNormalIntPer() {
        return normalIntPer;
    }

    public void setNormalIntPer(Float normalIntPer) {
    ...
    public Float getPeenalIntPer() {
        return peenalIntPer;
    }

    public void setPeenalIntPer(Float peenalIntPer) {
        this.peenalIntPer = peenalIntPer;
    }

    public Float getQisIntPer() {
        return qisIntPer;
    }

    public void setQisIntPer(Float qisIntPer) {
