...
//            }
    ...
    public FastReportBuilder generateExcelFormat() {
        ...
        try {
            ...
            AbstractColumn outStdBal = ReportBean.getColumn("outStdBal", Double.class, "GRAD TOTAL BANK ALL LOAN BALANCE", 80);
            AbstractColumn totalAmt = ReportBean.getColumn("totalAmt", Double.class, "TOTAL MONTHLY INSTALMENT AMOUNT", 80);
