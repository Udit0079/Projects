...
public class AlmTdRoiwiseOverdueReportPojo implements java.io.Serializable, Comparable {
    ...
    public int compareTo(Object o) {
        ...
        return new Double(this.roi).compareTo(new Double(((AlmTdRoiwiseOverdueReportPojo) o).roi));
    }
}
