<%-- 
    Document   : ProvisionalCertificate
    Created on : Feb 6, 2016, 3:14:18 PM
    Author     : saurabhsipl
--%>
...
<f:view>
    <html>
        <head>
            ...
            <title>Loan Interest Provisional Certificate</title>
                ...
                <h:panelGrid bgcolor="#fff" columns="1" id="outerPanel" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid columns="3" id="gridPanel2" style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup id="groupPanel2" layout="block">
                            ...
                            <h:outputText id="stxtDate" styleClass="output" value="#{ProvisionalCertificate.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="label2" styleClass="headerLabel" value="Loan Interest Provisional Certificate"/>
                        <h:panelGroup id="groupPanel3" layout="block">
                            <h:outputLabel id="label3" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{ProvisionalCertificate.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="leftPanel" style="width:100%;text-align:center;">
                        <h:panelGrid columnClasses="col2,col7" columns="2" id="msgRow" style="width:100%;text-align:center;" styleClass="row1">
                            <h:outputLabel id="lblMsg" styleClass="error" value="#{ProvisionalCertificate.message}"/>
                        </h:panelGrid>
                        <h:panelGrid columnClasses="col2,col7,col2,col7" columns="4" id="Row2" style="width:100%;text-align:left;" styleClass="row2">
                            ...
                            <h:panelGroup layout="block"  style="width:100%;text-align:left;" >
                                <h:inputText id="txtAccountNo" styleClass="input" style="width: 100px" value="#{ProvisionalCertificate.oldAcNo}" maxlength="#{ProvisionalCertificate.acNoMaxLen}">
                                    <a4j:support  action="#{ProvisionalCertificate.setDateAccountWise}" event="onblur"
                                                  reRender="calFromDate,calToDate,lblMsg,InterestCal,stxtAccNo"/>
                                </h:inputText>
                                <h:outputText id="stxtAccNo" styleClass="output" value="#{ProvisionalCertificate.accountNo}"/>
                            </h:panelGroup>
                        ...
                        <h:panelGrid columnClasses="col2,col7,col2,col7" columns="4" id="Row3" style="width:100%;text-align:left;" styleClass="row1">
                            ...
                            <rich:calendar datePattern="dd/MM/yyyy"  id="calFromDate"  value="#{ProvisionalCertificate.fromDate}" inputSize="10">
                            </rich:calendar>
                            <h:outputLabel id="lblToDate" styleClass="label" value="To Date"/>
                            <rich:calendar datePattern="dd/MM/yyyy"  id="calToDate"  value="#{ProvisionalCertificate.toDate}" inputSize="10">
                            </rich:calendar>
                        </h:panelGrid>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col1,col2" columns="1" id="InterestCal"  width="100%" styleClass="row2">
                        <a4j:region>
                            <rich:dataTable value ="#{ProvisionalCertificate.intCalc}"
                                ...
                                <f:facet name="footer">
                                    <rich:columnGroup style="background-color: #b0c4de;">
                                        ...
                                        <rich:column></rich:column>
                                        <rich:column style="text-align:right;">
                                            <h:outputText value="#{ProvisionalCertificate.totalNoOfDays}"><f:convertNumber   pattern="####.00"  /></h:outputText>
                                        </rich:column>
                                        <rich:column style="text-align:right;">
                                            <h:outputText value="#{ProvisionalCertificate.totalProduct}"><f:convertNumber   pattern="####.00"  /></h:outputText>
                                        </rich:column>
                                        <rich:column style="text-align:right;">
                                            <h:outputText value="#{ProvisionalCertificate.totalInt}"><f:convertNumber   pattern="####.00"  /></h:outputText>
                                        </rich:column>
                                        <rich:column></rich:column>
                                    </rich:columnGroup>
                                </f:facet>
                    ...
                    <h:panelGrid id="poFooterPanel" style="width:100%;text-align:center;" styleClass="footer">
                        <h:panelGroup id="btnPanel">
                            <a4j:commandButton id="btnCalculate" value="Calculate" action="#{ProvisionalCertificate.calculate}"
                                              reRender="lblMsg,leftPanel,InterestCal,calFromDate,calToDate">
                            </a4j:commandButton>
                            <a4j:commandButton id="btnPrint" value="PDF Download" action="#{ProvisionalCertificate.printPDF}"
                                              reRender="lblMsg,leftPanel,InterestCal,calFromDate,calToDate">
                            </a4j:commandButton>
                            <a4j:commandButton id="btnRefresh" value="Refresh" action="#{ProvisionalCertificate.refresh}"
                                              reRender="InterestCal,leftPanel">
                            </a4j:commandButton>
                            <a4j:commandButton id="btnExit" value="Exit" action="#{ProvisionalCertificate.exitBtnAction}" reRender="stxtAccNo">
                            </a4j:commandButton>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
