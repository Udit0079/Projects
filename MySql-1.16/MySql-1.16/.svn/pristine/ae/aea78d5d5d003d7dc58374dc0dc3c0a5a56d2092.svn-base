...
public class CBSRelatedPersonsDetailsTO implements Serializable {

    private static final long serialVersionUID = 1L;
    protected CBSRelatedPersonsDetailsPKTO cBSRelatedPersonsDetailsPKTO;
    ...
    public CBSRelatedPersonsDetailsPKTO getcBSRelatedPersonsDetailsPKTO() {
        return cBSRelatedPersonsDetailsPKTO;
    }

    public void setcBSRelatedPersonsDetailsPKTO(CBSRelatedPersonsDetailsPKTO cBSRelatedPersonsDetailsPKTO) {
        this.cBSRelatedPersonsDetailsPKTO = cBSRelatedPersonsDetailsPKTO;
    }
