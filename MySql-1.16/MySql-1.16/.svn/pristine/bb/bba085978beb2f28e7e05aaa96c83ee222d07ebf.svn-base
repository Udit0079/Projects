...
public class IncidentalCharges extends BaseBean {
    ...
    public void calculationData() {
        try {
            ...
            resultList1 = remoteObject.calculateCharges(this.acctype, Integer.parseInt(charge), ymd.format(this.fromDate),
    ...
    public void creditAcData() {
        try {
            String crdata = remoteObject.crAccount(acctype);
    ...
    public void postData() {
        ...
        try {
            ...
            String postvalue = remoteObject.postData(getOrgnBrCode(), getUserName(), dt, crdaccount,
            ...
            setMessage(postvalue);
            this.setMode("POST");
            resultList2 = remoteObject.reportPrintDetail(Float.parseFloat(tmpTrsNo), acctype, getUserName(), dt, getOrgnBrCode());
