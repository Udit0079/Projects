 ...
 * @author Athar Reza
 */
public class TopDepositorBorrowerPojo implements Serializable{
    private String acNo;
    private String deositorName;
    private String fatherName;
    private String address;
    private String pan;
    private BigDecimal depositAmt;
    private BigDecimal outStandingBal;
    private String sanctionLimitDt;
    ...
    public String getDeositorName() {
        return deositorName;
    }

    public void setDeositorName(String deositorName) {
        this.deositorName = deositorName;
    }
    ...
    public String getSanctionLimitDt() {
        return sanctionLimitDt;
    }

    public void setSanctionLimitDt(String sanctionLimitDt) {
        this.sanctionLimitDt = sanctionLimitDt;
    }
