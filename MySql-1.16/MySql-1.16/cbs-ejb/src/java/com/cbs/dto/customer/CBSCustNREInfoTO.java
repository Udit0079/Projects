 ...
 * @author root
 */
public class CBSCustNREInfoTO implements Serializable {
    ...
    public String getNreEmial() {
        return nreEmial;
    }

    public void setNreEmial(String nreEmial) {
        this.nreEmial = nreEmial;
    }
