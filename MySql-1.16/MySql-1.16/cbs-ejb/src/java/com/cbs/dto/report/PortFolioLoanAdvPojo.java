 ...
 * @author root
 */
public class PortFolioLoanAdvPojo {
    Integer sNo;
    ...
    String fSssGNo;
    String fSsssGNo;
    public BigDecimal loanAmt,	odCcAmt, billDiscAmt;
    ...
    public BigDecimal getOdCcAmt() {
        return odCcAmt;
    }

    public void setOdCcAmt(BigDecimal odCcAmt) {
        this.odCcAmt = odCcAmt;
    }
