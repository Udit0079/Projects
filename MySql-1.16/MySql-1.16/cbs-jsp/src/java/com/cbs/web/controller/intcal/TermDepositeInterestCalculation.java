...
public class TermDepositeInterestCalculation extends BaseBean {
     ...
     */
    public TermDepositeInterestCalculation() {
        try {
    ...
    public void callProcedureForCalculateAndPost() {
        ...
        try {
            ...
            if (mode.equalsIgnoreCase("POST")) {
                ...
                String msg = tdInterestCalculationMainRemote.tdInterestPosting(tdIntCalList, toDt, currDt, acType, this.glAcNo, this.interestOption.substring(0, 1),
                ...
                tdIntCalList = tdInterestCalculationMainRemote.tdInterestCalculation(frDt, toDt, this.acType, this.interestOption.substring(0, 1), getUserName(),
                ...
                if (tdIntCalList.isEmpty()) {
                    ...
                    new ReportBean().jasperReport("TD_INT_CAL", "text/html", new JRBeanCollectionDataSource(tdIntCalList),
                            fillParams, report);
