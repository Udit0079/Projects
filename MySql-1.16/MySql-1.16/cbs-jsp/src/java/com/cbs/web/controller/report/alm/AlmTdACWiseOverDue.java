...
public final class AlmTdACWiseOverDue extends BaseBean {

    private String message;
    private String calDate;
    ALMReportFacadeRemote beanRemote;

    public AlmTdACWiseOverDue() {
    }
    ...
    public String printAction() {
        ...
        try {
            ...
            List<AlmTdAccountWiseReportPojo> almTdAccountWiseReport = beanRemote.getAlmTdAccountWiseReport(dt, getOrgnBrCode(), true);
            ...
            if (!almTdAccountWiseReport.isEmpty()) {
                ...
                String repName = "ALM Term Deposit Account Wise Overdue Report";
                Map fillParams = new HashMap();
                fillParams.put("asOnDate", calDate);
                fillParams.put("pPrintedBy", getUserName());
                fillParams.put("pBankName", bankName);
                fillParams.put("pBranchAddress", branchAddress);                
                new ReportBean().jasperReport("almtdacwiseoverdue", "text/html", new JRBeanCollectionDataSource(almTdAccountWiseReport), fillParams, repName);
                return "report";
            } else {
                setMessage("Data does not exist.");
            }
