                ...
                <h:panelGrid columns="1" id="a1" width="100%" bgcolor="#fff" style="border:1px ridge #BED6F8">
                    <h:panelGrid columns="3" id="gridPanel2" styleClass="header" style="width:100%;text-align:center;">
                        <h:panelGroup id="a2" layout="block">
                            ...
                            <h:outputText id="stxtDate" styleClass="output" value="#{HoGLBMaster.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel styleClass="headerLabel" value="GLB Master"/>
                        <h:panelGroup layout="block">
                            <h:outputLabel styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{HoGLBMaster.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="lpg" columns="1" style="width:100%;height:30px;text-align:center;background-color:#e8eef7">
                        <h:outputText id="errorMessage" styleClass="error" value="#{HoGLBMaster.errorMessage}"/>
                        <h:outputText id="message" styleClass="msg" value="#{HoGLBMaster.message}"/>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col9" columns="2" id="a3" width="100%">
                        <h:panelGrid  columns="1" id="gridPanel1" width="100%">
                            <h:panelGrid columnClasses="col9" columns="2" id="a5" width="100%" style="height:30px;" styleClass="row1">
                                ...
                                <h:selectOneListbox id="ddType" tabindex="1" styleClass="ddlist"  value="#{HoGLBMaster.type}" size="1" style="width: 102px">
                                    <f:selectItems value="#{HoGLBMaster.typeList}" />
                                    <a4j:support action="#{HoGLBMaster.initialReset()}" event="onchange"
                                                 reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList" limitToList="true"/>
                                </h:selectOneListbox>
                            </h:panelGrid>
                            <h:panelGrid columnClasses="col9" columns="2" id="a7" width="100%" style="height:30px;" styleClass="row2">
                                ...
                                <h:inputText id="txtGrCode" tabindex="2" size="15" value="#{HoGLBMaster.grCode}" maxlength="10" onblur="this.value = this.value.toUpperCase();" styleClass="input"/>
                            </h:panelGrid>
                            <h:panelGrid columnClasses="col9" columns="6" id="a8" width="100%" style="height:30px;" styleClass="row1">
                                ...
                                <h:inputText id="txtCode" tabindex="5" value="#{HoGLBMaster.codeAcNo}" maxlength="8" onkeyup="this.value = this.value.toUpperCase();"  size="15" styleClass="input">
                                    <a4j:support action="#{HoGLBMaster.getAccountDetail}" event="onblur"
                                                 reRender="message,errorMessage,a8,a9,a11,newCode" limitToList="true" focus="txtCodeDesc"/>
                                </h:inputText>
                                <h:outputLabel id="newCode" styleClass="label" value="#{HoGLBMaster.newCode}"/>
                            </h:panelGrid>
                            <h:panelGrid columnClasses="col9" columns="2" id="a9" width="100%" style="height:30px;" styleClass="row2">
                                <h:outputLabel id="lblCodeDesc" styleClass="label" value="Code Description :" />
                                <h:outputText id="stxtCodeDesc" styleClass="output" value="#{HoGLBMaster.codeDesc}" style="color:blue;"/>
                            </h:panelGrid>
                            <h:panelGrid columnClasses="col9" columns="2" id="a14" width="100%" style="height:30px;" styleClass="row1">
                                ...
                                <h:selectOneListbox id="ddAcType" tabindex="8" styleClass="ddlist"  value="#{HoGLBMaster.acType}" size="1" style="width: 102px">
                                    <f:selectItems value="#{HoGLBMaster.acTypeList}" />
                                    <a4j:support action="#{HoGLBMaster.actypeDesc()}" event="onchange"
                        ...
                        <h:panelGrid columnClasses="col9" columns="2" id="a4" width="100%">
                            <h:panelGrid columns="1" id="gridPanel3" width="100%">
                                ...
                                <h:panelGrid columnClasses="col9" columns="2" id="a10" width="100%" style="height:30px;" styleClass="row2">
                                    ...
                                    <h:inputText id="txtSubGrCode" tabindex="3" size="15" value="#{HoGLBMaster.subGrCode}" maxlength="10" onkeyup="this.value = this.value.toUpperCase();" styleClass="input">
                                        <a4j:support action="#{HoGLBMaster.subGrCheck}" event="onblur"
                                                     reRender="message,errorMessage,a10,a5,a7" limitToList="true" focus="ddCode"/>
                                    </h:inputText>
                                </h:panelGrid>
                                <h:panelGrid columnClasses="col9" columns="2" id="a11" width="100%" style="height:30px;" styleClass="row1">
                                    <h:panelGroup layout="block" style="width:100%;text-align:center;">
                                        <h:inputText id="txtCodeDesc" tabindex="6" size="70" value="#{HoGLBMaster.codeDesc}" onblur="this.value = this.value.toUpperCase();" styleClass="input"/>
                                    </h:panelGroup>
                                </h:panelGrid>
                                <h:panelGrid columnClasses="col9" columns="2" id="a12" width="100%" style="height:30px;" styleClass="row2">
                                    ...
                                    <h:selectOneListbox id="ddAcStatus" tabindex="7" styleClass="ddlist"  value="#{HoGLBMaster.acStatus}" size="1" style="width: 102px">
                                        <f:selectItems value="#{HoGLBMaster.acStatusList}" />
                                    </h:selectOneListbox>
                                </h:panelGrid>
                                <h:panelGrid columnClasses="col9" columns="2" id="a13" width="100%" style="height:30px;" styleClass="row1">
                                    ...
                                    <h:outputText id="stxtAcTypeDesc" styleClass="output" value="#{HoGLBMaster.acTypeDesc}" style="color:blue;"/>
                                </h:panelGrid>
                            </h:panelGrid>
                        </h:panelGrid>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="vtop" columns="1" id="table" style="height:auto;" styleClass="row2" width="100%">
                        <a4j:region>
                            <rich:dataTable value="#{HoGLBMaster.gridDetail}" var="dataItem"
                                ...
                                <rich:column>
                                    <a4j:commandLink ajaxSingle="true" id="deletelink" oncomplete="#{rich:component('deletePanel')}.show()" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList">
                                        ...
                                        <f:setPropertyActionListener value="#{dataItem}" target="#{HoGLBMaster.currentItem}"/>
                                    </a4j:commandLink>
                                </rich:column>
                            </rich:dataTable>
                    ...
                    <h:panelGrid columns="1" id="gpFooter" style="width:100%;text-align:center;" styleClass="footer">
                        <h:panelGroup layout="block" style="width:100%;text-align:center;">
                            <a4j:commandButton id="btnSave" tabindex="9" value="Save" oncomplete="#{rich:component('savePanel')}.show()" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList,newCode" focus="ddType"/>
                            <a4j:commandButton id="btnRefresh" tabindex="10" value="Refresh" action="#{HoGLBMaster.resetForm}" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList,newCode" focus="ddType"/>
                            <a4j:commandButton id="btnExit" tabindex="11" value="Exit" action="#{HoGLBMaster.exitBtnAction}" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList,newCode"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
            </a4j:form>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" width="50%">
                                    <a4j:commandButton value="Yes" ajaxSingle="true"  action="#{HoGLBMaster.delete}"
                                                       oncomplete="#{rich:component('deletePanel')}.hide();" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList,newCode" focus="ddType"/>
                                </td>
                                <td align="center" width="50%">
                ...
                <h:form>
                    <table width="100%">
                        <tbody>
                            <tr>
                                <td align="center" width="50%">
                                    <a4j:commandButton value="Yes" ajaxSingle="true" action="#{HoGLBMaster.saveDetail}"
                                                       oncomplete="#{rich:component('savePanel')}.hide();" reRender="a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,message,errorMessage,lpg,gpFooter,table,taskList,newCode" focus="ddType"/>
                                </td>
                                <td align="center" width="50%">
