...
<f:view>
    <html>
        <head>
            ...
            <title>ATM Seq File Generation</title>
                ...
                <h:panelGrid id="mainPanel" bgcolor="#fff" columns="1"  style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid id="headerPanel" columns="3"  style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup>
                            ...
                            <h:outputText id="stxtDate" styleClass="output" value="#{atmSeqFileBean.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="lblTitle" styleClass="headerLabel" value="ATM Sequence File"/>
                        <h:panelGroup id="groupPanel2" layout="block">
                            <h:outputLabel id="lblUser" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{atmSeqFileBean.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col8,col8" columns="2" id="messagePanel" style="width:100%;text-align:center;" styleClass="row1" width="100%">
                        <h:outputText id="stxtMessage" styleClass="error" value="#{atmSeqFileBean.errorMessage}"/>
                    </h:panelGrid>
                    <h:panelGrid id="modeGrid" columnClasses="col3,col3,col3,col3,col3,col3" columns="6" style="height:30px;" styleClass="row2" width="100%">
                        ...
                        <h:selectOneListbox id="ddMode" style="width:180px" styleClass="ddlist"  value="#{atmSeqFileBean.mode}" size="1">
                            <f:selectItems value="#{atmSeqFileBean.modeList}"/>
                            <a4j:support event="onblur" action="#{atmSeqFileBean.onChangeFunction}" reRender="stxtMessage,btnHtml,txtGenDate" oncomplete="setMask();" focus="ddFileType"/>
                        </h:selectOneListbox>
                        <h:outputLabel id="lblFileType" styleClass="label" value="File Type"><font class="required" color="red">*</font></h:outputLabel>
                        <h:selectOneListbox id="ddFileType" style="width:180px" styleClass="ddlist"  value="#{atmSeqFileBean.fileType}" size="1">
                            <f:selectItems value="#{atmSeqFileBean.fileTypeList}"/>
                        </h:selectOneListbox>
                        <h:outputLabel id="lblGenDate" styleClass="label" value="Date"><font class="required" color="red">*</font></h:outputLabel>
                        <h:inputText id="txtGenDate" styleClass="input issueDt" value="#{atmSeqFileBean.fileGenerationDt}" size="10"/>                 
                    </h:panelGrid>
                    <h:panelGrid id="footerPanel" style="width:100%;text-align:center;" styleClass="footer" >
                        <h:panelGroup id="btnPanel">
                            <a4j:commandButton id="btnHtml" value="#{atmSeqFileBean.btnValue}" action="#{atmSeqFileBean.createConfirmTxt}" oncomplete="#{rich:component('processPanel')}.show();setMask();" reRender="stxtMessage,processPanel,confirmid"/>
                            <a4j:commandButton id="btnRefresh" value="Refresh" action="#{atmSeqFileBean.btnRefreshAction}" reRender="mainPanel" oncomplete="setMask();"/>
                            <a4j:commandButton id="btnExit" value="Exit" action="#{atmSeqFileBean.btnExitAction}" reRender="mainPanel"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="tablePanel" columns="1" columnClasses="vtop" style="border:1px ridge #BED6F8;" styleClass="row2" width="100%">
                        <a4j:region id="tblRegion">
                            <rich:dataTable value="#{atmSeqFileBean.gridDetail}" var="dataItem"
                                ...
                                <rich:column style="text-align:center;width:40px">
                                    <a4j:commandLink ajaxSingle="true" id="selectlink" action="#{atmSeqFileBean.downloadFile}" reRender="mainPanel">
                                        <h:graphicImage value="/resources/images/passed.gif" style="border:0"/>
                                        <f:setPropertyActionListener value="#{dataItem}" target="#{atmSeqFileBean.currentItem}"/>
                                    </a4j:commandLink>
                                </rich:column>
                            </rich:dataTable>
                    ...
                    <table width="100%" style="background-color:#edebeb;text-align:center;font-weight:bold;">
                        <tbody>
                            <tr style="height:40px">
                                <td colspan="2">
                                    <h:outputText id="confirmid" value="#{atmSeqFileBean.confirmText}"/>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" width="50%">
                                    <a4j:commandButton value="Yes" id="btnYes" action="#{atmSeqFileBean.processAction}" 
                                                       oncomplete="#{rich:component('processPanel')}.hide(); #{rich:element('ddMode')}.focus();setMask();" 
