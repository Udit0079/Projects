<%--
    Document   : incidental charges
    Created on : Aug 2, 2010, 7:47:03 PM
...
<f:view>
    <html>
        <head>
            ...
            <title>Incidental Charges</title>
                ...
                <h:panelGrid bgcolor="#fff" id="mainPanel" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid columns="3" id="gridPanel" style="width:100%;text-align:center;" styleClass="header" width="100%">
                        <h:panelGroup id="groupPanel" layout="block" >
                            ...
                            <h:outputText id="stxtDate" styleClass="headerLabel" value="#{IncidentalCharges.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="lblincident" styleClass="headerLabel" value="Incidental Charges"/>
                        <h:panelGroup id="groupPanel2" layout="block">
                            <h:outputLabel id="lbluser" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="headerLabel" value="#{IncidentalCharges.userName}" />
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid columns="1" id="d22" styleClass="row1" width="100%" style="text-align:center;">
                        <h:outputText id="stxtmessage" styleClass="error" value="#{IncidentalCharges.message}"  />
                    </h:panelGrid>
                    <h:panelGrid columnClasses="col9,col9" columns="2" id="a9" width="100%">
                        <h:panelGrid id="gridPanel1" columns="2" columnClasses="col9,col9" style="height:30px;" styleClass="row2" width="100%">
                            ...
                            <h:selectOneListbox id="ddstatus" styleClass="ddlist" size="1" style="width: 100px" value="#{IncidentalCharges.status}" disabled="#{IncidentalCharges.flag}" >
                                <f:selectItems value="#{IncidentalCharges.statusType}"/>
                            </h:selectOneListbox>
                        </h:panelGrid>
                        <h:panelGrid columns="2" columnClasses="col9,col9" id="grdPanel2" style="height:30px;" styleClass="row2" width="100%">
                            ...
                            <h:selectOneListbox id="ddactype" styleClass="ddlist" size="1" style="width: 100px" value="#{IncidentalCharges.acctype}" disabled="#{IncidentalCharges.flag1}" >
                                <f:selectItems value="#{IncidentalCharges.acctTypeOption}"/>
                            </h:selectOneListbox>
                        </h:panelGrid>
                        <h:panelGrid columns="2" columnClasses="col9" id="gridPanel31" style="height:30px;" styleClass="row1"  width="100%">
                            ...
                            <rich:calendar id="calfrom" styleClass="rich-calendar-input" datePattern="dd/MM/yyyy" value="#{IncidentalCharges.fromDate}" disabled="#{IncidentalCharges.flag2}" inputSize="10"></rich:calendar>
                        </h:panelGrid>
                        <h:panelGrid columns="2" columnClasses="col9" id="gridPanel32" style="height:30px;" styleClass="row1" width="100%">
                            ...
                            <rich:calendar id="calto" styleClass="rich-calendar-input" datePattern="dd/MM/yyyy" value="#{IncidentalCharges.toDate}" disabled="#{IncidentalCharges.flag3}" inputSize="10"></rich:calendar>
                        </h:panelGrid>
                        ...
                        <h:panelGrid columns="2"  columnClasses="col9" id="d3" style="height:30px;" styleClass="row2" width="100%" >
                            ...
                            <h:outputText id="stxtDebit1" styleClass="output" value="#{IncidentalCharges.debAcctype}"/>
                        </h:panelGrid>
                        <h:panelGrid columns="2" columnClasses="col9" id="b10" style="height:30px;" styleClass="row1" width="100%" >
                            ...
                            <h:outputText id="stxtcrdaccount" styleClass="output" value ="#{IncidentalCharges.crdaccount}"/>
                        </h:panelGrid>
                        <h:panelGrid columns="2" columnClasses="col9" id="b9" style="height:30px;" styleClass="row1" width="100%" >
                            ...
                            <h:outputText id="stxtCredit" styleClass="output" value="#{IncidentalCharges.crdAcctype}"/>
                        </h:panelGrid>
                    </h:panelGrid>
                    <h:panelGrid columns="2" columnClasses="col9" id="grdpanel4" style="height:30px;" styleClass="row2" width="100%" >
                        ...
                        <h:inputText id="txtcharge" styleClass="input"  size="15"  value="#{IncidentalCharges.charge}" disabled="#{IncidentalCharges.flag4}" maxlength="8"/>
                    </h:panelGrid>
                    <h:panelGrid columnClasses="vtop" columns="1" id="a19" style="height:auto;" styleClass="row1" width="100%">
                        <a4j:region>
                            <rich:dataTable value="#{IncidentalCharges.incis}" var="dataItem"
                    ...
                    <h:panelGrid columns="1" id="gridpanel6" style="width:100%;text-align:center;" styleClass="footer" >
                        <h:panelGroup layout="block" style="width:100%;text-align:center;">
                            <a4j:commandButton value="Calculate" id="btn31" disabled="#{IncidentalCharges.flag5}"  oncomplete="#{rich:component('savePanel')}.show()"/>
                            <a4j:commandButton value="Post" id="btn2" disabled="#{IncidentalCharges.flag6}" oncomplete="#{rich:component('dishonorPanel')}.show()"/>
                            <a4j:commandButton id="btn3"  value="Refresh" action="#{IncidentalCharges.reSet}" reRender="stxtDebit1,stxtCredit,a19,stxtcrdaccount,stxtmessage,ddstatus,ddactype,calfrom,calto,txtcharge,btn31,btn2" focus="ddstatus"/>
                            <a4j:commandButton id="btn4"  value="Exit" action="#{IncidentalCharges.exitBtnAction}" reRender="stxtDebit1,stxtCredit,a19,stxtcrdaccount,stxtmessage,ddstatus,ddactype,calfrom,calto,txtcharge,btn31,btn2" />
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
            </a4j:form>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center" width="50%">
                                    <a4j:commandButton value="Yes" id="btnCalcYes" action="#{IncidentalCharges.calculationData}"
                                                       oncomplete="#{rich:component('savePanel')}.hide();
                                                                     if(#{IncidentalCharges.flag6==false})
                                                                     {
                                                                        #{rich:component('popUpRepPanel')}.show();
                                                                     }
                                                                     else if(#{IncidentalCharges.flag6==true})
                                                                     {
                ...
                <h:form>
                    <table width="100%" style="background-color:#edebeb;text-align:center;font-weight:bold;">
                        <tbody>
                            ...
                            <tr>
                                <td align="center" width="50%">
                                    <a4j:commandButton value="Yes" id="btnPostYes" action="#{IncidentalCharges.postData}" 
                                                       ...
                                                       if(#{IncidentalCharges.flag6==true})
                                                       {
                                                          #{rich:component('popUpRepPanel')}.show();
                                                       }
                                                       else if(#{IncidentalCharges.flag6==false})
                                                       {
                                                         #{rich:component('popUpRepPanel')}.hide();
                                                       }"/>
             ...
             <rich:modalPanel id="popUpRepPanel" label="Form" width="1000" height="550" resizeable="true" moveable="false" onmaskdblclick="#{rich:component('popUpRepPanel')}.hide();">
                ...
                <table width="100%">
                    <tbody>
                        <tr>
                            <td>
                                <a4j:include viewId="#{IncidentalCharges.viewID}" />
                            </td>
