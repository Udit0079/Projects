                ...
                <h:panelGrid id="mainPanel" bgcolor="#fff" columns="1" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid columns="3" id="headepanel" style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup id="groupPanel2" layout="block">
                            ...
                            <h:outputText id="stDate" styleClass="output" value="#{AdvanceActivity.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="OL30" styleClass="headerLabel" value="Advance Activity"/>
                        <h:panelGroup id="groupPanel3" layout="block">
                            <h:outputLabel id="label3" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{AdvanceActivity.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>

                    <h:panelGrid columnClasses="col2" columns="2" id="errPanel" style="text-align:center;" width="100%" styleClass="row2">
                        <h:outputText id="errMsg" value="#{AdvanceActivity.message}" styleClass="error"/>
                    </h:panelGrid>
                     <h:panelGrid columnClasses="col3,col3,col3,col3,col3,col3" columns="6" id="gridPanelFunc" style="text-align:left;" width="100%" styleClass="row2">
                        ...
                        <h:selectOneListbox size="1" id="operationList" style="width:120px" styleClass="ddlist" value="#{AdvanceActivity.operation}">
                                <f:selectItems value="#{AdvanceActivity.operationList}"/>
                                <a4j:support event="onblur" action="#{AdvanceActivity.setOperationOnBlur}" reRender="popUpGridPanel,popUpGridEditPanel,mainPanel" oncomplete="if(#{AdvanceActivity.operation=='1'}){ #{rich:component('popUpGridEditPanel')}.hide(); #{rich:component('popUpGridPanel')}.show(); } else if(#{AdvanceActivity.operation=='2'}){  #{rich:component('popUpGridPanel')}.hide(); #{rich:component('popUpGridEditPanel')}.show(); };" />
                        </h:selectOneListbox>
                         <h:outputText/>
                        <h:outputText/>
                        <h:outputText/>
                    ...
                    <rich:panel header="Employee Detail">
                        <h:panelGrid id="mainPanel1" bgcolor="#fff" columns="1" style="border:1px ridge #BED6F8" width="100%">
                          <h:panelGrid columnClasses="col3,col3,col3,col3,col3,col3" columns="6" id="gridPanel1" style="text-align:left;" width="100%" styleClass="row1">
                                ...
                                <h:inputText id="txtEmployeeId" value="#{AdvanceActivity.empId}" disabled="true" styleClass="input" maxlength="20"/>
                                <h:outputLabel styleClass="label" value="Employee Name"/>
                                <h:inputText id="txtEmployeeName" value="#{AdvanceActivity.empName}" disabled="true" styleClass="input" maxlength="100"/>
                                <h:outputLabel styleClass="label" value="Department"/>
                                <h:inputText id="txtDepartment" value="#{AdvanceActivity.department}" disabled="true" styleClass="input" maxlength="20"/>
                            </h:panelGrid>
                            ...
                            <h:panelGrid columnClasses="col3,col3,col3,col3,col3,col3" columns="6" id="gridPanel2" style="text-align:left;" width="100%" styleClass="row2">
                                ...
                                <h:inputText id="txtDesignation" value="#{AdvanceActivity.designation}" disabled="true"  styleClass="input" maxlength="20"/>
                                <h:outputLabel styleClass="label" value="Grade"/>
                                <h:inputText id="txtGrade" value="#{AdvanceActivity.grade}" disabled="true" styleClass="input" maxlength="20"/>
                                <h:outputLabel styleClass="label" value="Basic Salary"/>
                                <h:inputText id="txtBasicSalary" value="#{AdvanceActivity.basicSalary}" disabled="true" styleClass="input" maxlength="20"/>
                            </h:panelGrid>
                        </h:panelGrid>
                    </rich:panel>

                    <rich:panel header="Advance Detail">
                        <h:panelGrid id="mainPanel12" bgcolor="#fff" columns="1" style="border:1px ridge #BED6F8" width="100%">
                            <h:panelGrid columnClasses="col3,col3,col3,col3,col3,col3" columns="6" id="gridPanel4" style="text-align:left;" width="100%" styleClass="row1">
                                <h:outputLabel styleClass="label" value="Advance Type"/>
                                <h:selectOneListbox id="ddAdvanceType" size="1" styleClass="ddlist" style="width:130px" value="#{AdvanceActivity.advanceType}">
                                    <f:selectItems value="#{AdvanceActivity.advancesList}"/>
                                </h:selectOneListbox>
                                <h:outputLabel styleClass="label" value="Sanction Date"/>
                                <rich:calendar enableManualInput="true" id="calSanctionDate" value="#{AdvanceActivity.sanctionDate}" datePattern="dd/MM/yyyy"/>
                                <h:outputLabel styleClass="label" value="Sanction Amount"/>
                                <h:inputText id="txtSanctionAmount" value="#{AdvanceActivity.sanctionAmount}" styleClass="input" maxlength="10"/>
                            </h:panelGrid>
                            ...
                            <h:panelGrid columnClasses="col3,col3,col3,col3,col3,col3" columns="6" id="gridPanel5" style="text-align:left;" width="100%" styleClass="row2">
                                ...
                                <h:inputText id="txtNoOfInstallment" value="#{AdvanceActivity.noOfInstallment}" styleClass="input" maxlength="5"/>
                                <h:outputLabel styleClass="label" value="Periodicity"/>
                                <h:selectOneListbox id="ddPeriodicity" size="1" styleClass="ddlist" style="width:130px" value="#{AdvanceActivity.periodicity}">
                                    <f:selectItems value="#{AdvanceActivity.periodicityList}"/>
                                </h:selectOneListbox>
                                <h:outputLabel styleClass="label" value="Starting Date"/>
                                <rich:calendar enableManualInput="true" id="calStartingDate" datePattern="dd/MM/yyyy" value="#{AdvanceActivity.startingDate}"/>
                            </h:panelGrid>

                            <h:panelGrid id="footerPanel1" style="width:100%;text-align:center;" styleClass="row1">
                                <a4j:commandButton id="btnInstallmentPlan" value="Installment Plan" action="#{AdvanceActivity.calculateInstallmentPlan}"
                                                   oncomplete="if(#{AdvanceActivity.flag1==true})
                                                   {
                                                   #{rich:component('acView1')}.show();
                                                   }
                                                   " reRender="errMsg,acView1,mainPanel" focus="acViewClose1"/>
                                <rich:modalPanel id="acView1" autosized="true" style="text-align:center">
                                    ...
                                    <h:panelGrid columnClasses="vtop" columns="1" id="gridPanelInstallment" width="100%" styleClass="row2" >
                                        ...
                                        <rich:dataTable value="#{AdvanceActivity.table}" var="dataItem"
                                                        rowClasses="row1, row2" id="InstallmentList"
                                                        rows="10" columnsWidth="100" rowKeyVar="row"
                    ...
                    <h:panelGrid id="footerPanel2" style="width:100%;text-align:center;" styleClass="footer">
                        <h:panelGroup id="btnPanel">
                            <a4j:commandButton id="btnSave" value="Save" action="#{AdvanceActivity.saveAction}"  disabled="#{AdvanceActivity.disableSaveButton}"
                                               reRender="mainPanel"/>
                            <a4j:commandButton id="btnDelete" disabled="#{AdvanceActivity.disableDeleteButton}"  value="Delete" action="#{AdvanceActivity.deleteAction}" reRender="mainPanel"/>
                            <a4j:commandButton id="btnCancel" value="Cancel" action="#{AdvanceActivity.cancelAction}" type="reset" reRender="mainPanel"/>
                            <a4j:commandButton id="btnExit" value="Exit" action="#{AdvanceActivity.exitAction}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
                ...
                <f:facet name="header">
                    <h:panelGrid style="width:100%;text-align:center;">
                      ...
                      <h:panelGrid columnClasses="vtop" columns="1" id="table2"  styleClass="row2" width="100%">
                                <a4j:region>
                                    <rich:dataTable value="#{AdvanceActivity.advanceTable}" var="dataItem"
                                        ...
                                        <rich:column style="text-align:center;width:40px">
                                            <a4j:commandLink id="selectlink2" action="#{AdvanceActivity.setAdvanceRowValues}"
                                                             oncomplete="#{rich:component('popUpGridEditPanel')}.hide()"
                                                             reRender="txtEmployeeId,txtEmployeeName,txtDepartment,txtDesignation,txtGrade,
                                                             txtBasicSalary,taskList2,table2,table1,ddAdvanceType,calSanctionDate,txtSanctionAmount,
                                                             txtROI,txtNoOfInstallment,ddloanPlan,ddPeriodicity,calStartingDate,txtAuthorizedUser,
                                                             btnSave,btnView,btnDelete" focus="selectlink2">
                                                <h:graphicImage value="/resources/images/select.gif" style="border:0" />
                                                <f:setPropertyActionListener value="#{dataItem}" target="#{AdvanceActivity.currentAdvanceItem}"/>
                                            </a4j:commandLink>
                                        </rich:column>
                                    </rich:dataTable>
                ...
                <a4j:form>
                      <h:panelGrid id="PanelGridEmptable" bgcolor="#fff" styleClass="row2" columns="1" style="border:1px ridge #BED6F8" width="100%">
                                ...
                                <h:panelGroup layout="block">
                                    ...
                                    &nbsp;
                                    <h:inputText id="txtSearchValue" value="#{AdvanceActivity.empSearchValue}" maxlength="100" onkeyup="this.value = this.value.toUpperCase();" styleClass="input"/>
                                    &nbsp;
                                    <h:outputLabel value="By"/>
                                    &nbsp;
                                    <h:selectOneListbox id="ddSearchCriteria" value="#{AdvanceActivity.empSearchCriteria}" size="1">
                                        <f:selectItem itemValue="Name"/>
                                        <f:selectItem itemValue="ID"/>
                                    </h:selectOneListbox>                                    
                                    &nbsp;
                                    <a4j:commandButton value="Find" action="#{AdvanceActivity.getEmployeeTableData}" reRender="emptablepanel,EmpDetail,noOfRows,table1,table2,taskList1"/>
                                </h:panelGroup>
                            ...
                            <h:panelGrid columnClasses="vtop" columns="1" id="table1"  styleClass="row2" width="100%">
                                <a4j:region>
                                    <rich:dataTable value="#{AdvanceActivity.empSearchTable}" var="dataItem"
                                        ...
                                        <rich:column style="text-align:center;width:40px">
                                            <a4j:commandLink id="selectlink" action="#{AdvanceActivity.setEmpRowValues}" reRender="mainPanel" oncomplete="#{rich:component('popUpGridPanel')}.hide()" >
                                                <h:graphicImage value="/resources/images/select.gif" style="border:0" />
                                                <f:setPropertyActionListener value="#{dataItem}" target="#{AdvanceActivity.currentEmpItem}"/>                                                
                                            </a4j:commandLink>
                                        </rich:column>
                                    </rich:dataTable>
