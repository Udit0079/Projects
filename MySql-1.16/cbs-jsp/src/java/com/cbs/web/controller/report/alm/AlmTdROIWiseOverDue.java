...
public final class AlmTdROIWiseOverDue extends BaseBean {

    private String message;
    String calDate;
    ALMReportFacadeRemote beanRemote;

    public AlmTdROIWiseOverDue() {
    }
    ...
    public String printAction() {
        ...
        try {
            ...
            List<AlmTdRoiwiseOverdueReportPojo> almTdRoiWiseOverdueReport = beanRemote.getAlmTdRoiWiseOverdueReport(dt, getOrgnBrCode());
            if (almTdRoiWiseOverdueReport == null) {
                setMessage("System error occurred");
                return null;
            }
            if (!almTdRoiWiseOverdueReport.isEmpty()) {
                ...
                String repName = "ALM Term Deposit ROI Wise Overdue Report";
                Map fillParams = new HashMap();
                fillParams.put("asOnDate", calDate);
                fillParams.put("pPrintedBy", getUserName());
                fillParams.put("pBankName", bankName);
                fillParams.put("pBranchAddress", branchAddress);                
                new ReportBean().jasperReport("almtdroiwiseoverdue", "text/html", new JRBeanCollectionDataSource(almTdRoiWiseOverdueReport), fillParams, repName);
                return "report";
            } else {
