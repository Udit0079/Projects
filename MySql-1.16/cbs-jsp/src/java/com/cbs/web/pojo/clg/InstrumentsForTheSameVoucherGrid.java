 ...
 * @author root
 */
public class InstrumentsForTheSameVoucherGrid implements Serializable{
    ...
    public String getBcbpCode() {
        return bcbpCode;
    }

    public void setBcbpCode(String bcbpCode) {
        this.bcbpCode = bcbpCode;
    }
    ...
    public void setCircleMode(String circleMode) {
    ...
    public String getAcNosanNo() {
        return acNosanNo;
    }

    public void setAcNosanNo(String acNosanNo) {
        this.acNosanNo = acNosanNo;
    }
