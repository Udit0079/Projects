 ...
 * @version $Id: JRTextExporter.java 1413 2006-09-28 10:47:40Z teodord $
 */
public class SiplTextExporter extends JRAbstractExporter {
    ...
    public void exportReport() throws JRException {
        ...
        Float characterWidthParam = (Float) parameters.get(JRTextExporterParameter.CHARACTER_WIDTH);
        if (characterWidthParam != null) {
            characterWidth = characterWidthParam.floatValue();
            if (characterWidth < 0) {
        ...
        Float characterHeightParam = (Float) parameters.get(JRTextExporterParameter.CHARACTER_HEIGHT);
        if (characterHeightParam != null) {
            characterHeight = characterHeightParam.floatValue();
    ...
    protected void exportReportToWriter() throws JRException, IOException {
        for (int reportIndex = 0; reportIndex < jasperPrintList.size(); reportIndex++) {
            ...
            if (pages != null && pages.size() > 0) {
                ...
                if (characterWidth > 0) {
                    pageWidth = (int) (jasperPrint.getPageWidth() / characterWidth);
                }
                if (characterHeight > 0) {
                    pageHeight = (int) (jasperPrint.getPageHeight() / characterHeight);
                }
