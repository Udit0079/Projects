                ...
                <h:panelGrid id="mainPanel" columns="1" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid id="gridPanel" columns="3" style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup id="groupPanel" layout="block">
                            ...
                            <h:outputText id="stxtDate" styleClass="output" value="#{uploadMms.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="label" styleClass="headerLabel" value="Upload MMS"/>
                        <h:panelGroup id="groupPanel1" layout="block">
                            <h:outputLabel id="label4" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{uploadMms.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="errormsg" style="height:1px;text-align:center" styleClass="error" width="100%">
                        <h:outputText id="errmsg" value="#{uploadMms.message}"/>
                    </h:panelGrid>
                    <h:panelGrid id="gridPanel1" columnClasses="col2,col7,col7,col2" columns="4" width="100%">
                        ...
                        <t:inputFileUpload id="file" value="#{uploadMms.uploadedFile}" required="false"/>
                        <h:outputLabel/>
                    </h:panelGrid>
                    <h:panelGrid columns="2" id="a6" style="height:30px;" styleClass="footer" columnClasses="col7,col7,col7" width="100%">
                        <h:panelGroup layout="block" style="width:100%;text-align:center;">
                            <h:commandButton id="btnUpload" value="Upload" action="#{uploadMms.uploadProcess}"/>
                            <h:commandButton id="btnRefresh" value="Refresh" action="#{uploadMms.refreshForm}"/>
                            <h:commandButton id="btnExit" value="Exit" action="#{uploadMms.exitForm}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
            </h:form>
