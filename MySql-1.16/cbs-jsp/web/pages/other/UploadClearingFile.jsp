...
<f:view>
    <html>
        <head>
            ...
            <title>Upload Clearing File</title>
        </head>
        <body>
                ...
                <h:panelGrid id="mainPanel" columns="1" style="border:1px ridge #BED6F8" width="100%">
                    <h:panelGrid columns="3" id="gridPanel" style="width:100%;text-align:center;" styleClass="header">
                        <h:panelGroup id="groupPanel" layout="block">
                            ...
                            <h:outputText id="stxtDate" styleClass="output" value="#{uploadClearingFile.todayDate}"/>
                        </h:panelGroup>
                        <h:outputLabel id="label" styleClass="headerLabel" value="Upload Clearing File"/>
                        <h:panelGroup id="groupPanel1" layout="block">
                            <h:outputLabel id="label4" styleClass="headerLabel" value="User: "/>
                            <h:outputText id="stxtUser" styleClass="output" value="#{uploadClearingFile.userName}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                    <h:panelGrid id="errormsg" style="height:1px;text-align:center" styleClass="error" width="100%">
                        <h:outputText id="errmsg" value="#{uploadClearingFile.msg}"/>
                    </h:panelGrid>
                    ...
                    <h:panelGrid columnClasses="col8,col8" columns="2" id="gridPanel15" width="100%">
                        <h:panelGrid columnClasses="col2,col1,col7,col2" columns="4" id="gridPanel17" width="100%">
                            ...
                            <t:inputFileUpload id="file" value="#{uploadClearingFile.uploadFile}"  accept="text" required="false"/>
                            <h:outputLabel/>
                        </h:panelGrid>
                    </h:panelGrid>
                    <h:panelGrid columns="2" id="a6" style="height:30px;" styleClass="footer" columnClasses="col7,col7,col7" width="100%">
                        <h:panelGroup layout="block" style="width:100%;text-align:center;">
                            <h:commandButton id="btnUpload" value="Upload" action="#{uploadClearingFile.uploadProcess}" />
                            <h:commandButton id="btnRefresh" value="Refresh" action="#{uploadClearingFile.refreshForm}"/>
                            <h:commandButton id="btnExit" value="Exit" action="#{uploadClearingFile.exitForm}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:panelGrid>
            </h:form>
